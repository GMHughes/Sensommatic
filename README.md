...
<b> Esl-sfetch option:</b> If this option is set to "yes", sensommatic will write out contigs using the hmmer esl-sfetch tool. This option requires that the hmmer esl miniapps suits is installed. Setting this to "yes" will improves speed and will not impact or alter predictions.

```
my $pseudogenome_esl = "yes"; #line 25
```
</p>
...
```
my $remove_intermediate= "yes"; #line 27
```
</p>
...
```
my $print_datestring = "no"; #line 28
```
</p>
...
```
my $multi_exon_range = 50000 #line 32
```
</p>
...
```
my $single_exon_range = 2500; #line 33
```
...
```
my $cover_threshold = 300; #line 36
```
...
```
my $identity_threshold = 70; #line 37
```
...
```
my $evalue_inclusion = "1e-30"; #line 38
```
...
```
my $opsin_multiexon = 1000; #line 43
```
...
```
my $taste_multiexon = 1000; #line 44
```
...
```
my $vomeronasl_multiexon = 2000; #line 45
```
...
```
my $max_length_external = 1300; #line 48
```
...
```
my $min_length_internal  = 500; #line 49
```
...
```
my $blastback_verification = 1; #line 58
```
...
```
my $percentage_cover_threshold = 0.6 #line 59
```
...
```
my $percentage_identity_threshold = 0.5; #line 60
```
...
```
my $evalue_threshold ="1e-30"; #line 61
```
...
my $annotation_short = "pseudogene_short"; #line 65

#START codon and no in frame stop codons
my $annotation_1 = "functional"; #line 66

#no START codon and no stop codons in any frame
my $annotation_2 = "functional"; #line 67

#no START codon and no in frame stop codons
my $annotation_3 = "functional"; #line 68

#START codon and in frame stop codon
my $annotation_4 = "pseudogene_nonsense"; #line 69 

#no START codon and stop codons in all frames
my $annotation_5 = "pseudogene_nonsense"; #line 70

#no START codon and in frame stop codon
my $annotation_6 = "pseudogene_nonsense"; #line 71
```
...
```
my $annotation_truncated = "truncated" #line 75
```
</p>
